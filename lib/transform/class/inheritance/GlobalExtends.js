...
var _ExtendsGlobalDetector = _interopRequireDefault(require("./ExtendsGlobalDetector"));
 ...
 */
var GlobalExtends = /*#__PURE__*/function () {
  function GlobalExtends() {
    _classCallCheck(this, GlobalExtends);

    this.extendsGlobalNode = undefined;
    this.detectors = [new _ExtendsGlobalDetector["default"]()];
  }
  /**
  ...
  _createClass(GlobalExtends, [{
    ...
    key: "detectExtendsGlobalNode",
    value: function detectExtendsGlobalNode(node) {
    ...
    key: "matchExtendsGlobal",
    value: function matchExtendsGlobal(node) {
