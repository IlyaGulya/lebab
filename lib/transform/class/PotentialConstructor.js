...
var PotentialConstructor = /*#__PURE__*/function (_PotentialMethod) {
  ...
  _createClass(PotentialConstructor, [{
    ...
    key: "isSuperOrThisCall",
    value: function isSuperOrThisCall(node) {
      return (0, _fMatches.matches)({
        type: 'VariableDeclarator'
      }, node);
    }
  }, {
    key: "isSuperConstructorCallAssignment",
    value: function isSuperConstructorCallAssignment(node) {
      var _this3 = this;
      ...
      return (0, _fMatches.matches)({
        ...
        expression: {
          ...
          callee: {
            type: 'MemberExpression',
            object: function object(obj) {
              return (0, _isEqualAst["default"])(obj, _this3.superClass);
            },
            property: {
              type: 'Identifier',
              name: 'call'
