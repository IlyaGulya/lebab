  ...
  _traverser["default"].traverse(ast, {
    enter: function enter(node, parent) {
      ...
      if (m = (0, _matchFunctionDeclaration["default"])(node) || (0, _matchFunctionVar["default"])(node)) {
        ...
        var directPotentialClass = potentialClasses[m.classIdentifier.name];
        ...
        var isStatic = potentialClass === directPotentialClass;

        if (potentialClass && isStatic) {
          potentialClass.addField(new _PotentialField["default"]({
